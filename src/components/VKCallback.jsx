    ...
    const handleVKCallback = async () => {
      ...
      try {
        ...
        const tokenResponse = await fetch(
          `https://registration-fastapi.onrender.com/api/v1/vk/get/token/${code}/${device_id}`,
          { credentials: "include" }
        );
    ...
    const loginWithVK = async (accessToken) => {
      try {
        ...
        const loginResponse = await fetch(
          `https://registration-fastapi.onrender.com/api/v1/vk/login/${accessToken}`,
          {
            method: "POST",
            credentials: "include",
    ...
    const registerWithVK = async (accessToken) => {
      try {
        ...
        const registrationResponse = await fetch(
          `https://registration-fastapi.onrender.com/api/v1/vk/registration/${accessToken}`,
          {
            method: "POST",
            credentials: "include",
            headers: { "Content-Type": "application/json" },
